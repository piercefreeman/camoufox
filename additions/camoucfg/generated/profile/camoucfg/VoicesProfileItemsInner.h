...
#ifndef CAMOUFOX_PROFILE_VoicesProfile_items_inner_H_
#define CAMOUFOX_PROFILE_VoicesProfile_items_inner_H_
...
class VoicesProfile_items_inner {
 public:
  ...
  explicit VoicesProfile_items_inner(const nlohmann::json& json) { fromJson(json); }
...
#endif  // CAMOUFOX_PROFILE_VoicesProfile_items_inner_H_
