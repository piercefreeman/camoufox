        ...
        Column {
            ...
            T {
                ...
                text: dlgAct === "promptInstall"
                    ? "Rotunda " + dlgVer + "-" + dlgBuild + " is now active but not installed. Install it now?"
                    : (dlgAct === "install" ? "Install" : dlgAct === "uninstall" ? "Remove" : "Set") +
                      " Rotunda " + dlgVer + "-" + dlgBuild +
            ...
            StackLayout {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                T {
                                    Layout.alignment: Qt.AlignHCenter
                                    text: "Run: pip install rotunda[geoip]"
                                    color: c.muted
                ...
                Panel {
                    ...
                    GridLayout {
                        ...
                        Muted { text: "Website" }
                        T {
                            text: "<a href='https://github.com/piercefreeman/rotunda' style='color:" + c.accent + "'>github.com/piercefreeman/rotunda</a>"
                            textFormat: Text.RichText
